...
internal object Points {
    private val constantPointsHex = listOf(
        listOf(
    ...
    val constantPoints = constantPointsHex.map {
        StarkCurve.createPoint(
            BigInteger(it[0], Constants.HEX_RADIX),
            BigInteger(it[1], Constants.HEX_RADIX)
        )
    }
}
